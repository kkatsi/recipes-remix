...
const Route = () => {
  ...
  return (
    <div className="main-background min-h-screen w-full p-6 sm:p-12">
      <div
      ...
      <div className="content mt-6 flex flex-col-reverse gap-4 sm:flex-row justify-between w-full">
        <div className="instructions flex flex-col gap-4 sm:max-w-[60%]">
          ...
          <ol className="list-none flex flex-col gap-4" style={{ counterReset: 'item' }}>
            {recipe.instructions.map((instruction, index) => (
              <li
                key={index}
                className="grid justify-start before:content-[counter(item)] before:mr-2 before:inline-flex before:items-center before:justify-center before:w-8 before:h-8 before:rounded-full before:border before:border-primary before:font-playfair before:font-black"
        ...
        <div className="indredients">
          <div className="container border-[0.5px] border-zinc-100 backdrop-blur-md w-full bg-zinc-200 bg-opacity-50 p-4 sm:w-[250px] flex flex-col gap-3">
            ...
            <hr className="h-[1px] border-0 w-full bg-primary" />
